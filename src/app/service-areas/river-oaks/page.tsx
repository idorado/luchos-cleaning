...
const canonical = "https://luchoscleaning.com/service-areas/river-oaks";
const area = getHoustonServiceArea("river-oaks");
...
export default async function RiverOaksServiceAreaPage() {
  return (
