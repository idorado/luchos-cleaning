...
const locationName = "Greenway / Upper Kirby Area";
...
const canonical = "https://luchoscleaning.com/service-areas/greenway-upper-kirby-area";
const area = getHoustonServiceArea("greenway-upper-kirby-area");
...
export default async function GreenwayUpperKirbyAreaServiceAreaPage() {
  return (
