...
const locationName = "Greater Uptown";
...
const canonical = "https://luchoscleaning.com/service-areas/greater-uptown";
const area = getHoustonServiceArea("greater-uptown");
...
export default async function GreaterUptownServiceAreaPage() {
  return (
