...
const locationName = "Briar Forest";
...
const canonical = "https://luchoscleaning.com/service-areas/briar-forest";
const area = getHoustonServiceArea("briar-forest");
...
export default async function BriarForestServiceAreaPage() {
  return (
