...
const locationName = "West University Place";
...
const canonical = "https://luchoscleaning.com/service-areas/west-university-place";
const area = getHoustonServiceArea("west-university-place");
...
export default async function WestUniversityPlaceServiceAreaPage() {
  return (
